...
METHOD SET_VML_SHAPE_FOOTER.
  ...
  IF is_footer-left_image IS NOT INITIAL.
    ep_content = lc_shape.
    REPLACE '{ID}' IN ep_content WITH lc_shape_footer_left.
  ENDIF.
  IF is_footer-center_image IS NOT INITIAL.
    ep_content = lc_shape.
    REPLACE '{ID}' IN ep_content WITH lc_shape_footer_center.
  ENDIF.
  IF is_footer-right_image IS NOT INITIAL.
    ep_content = lc_shape.
    REPLACE '{ID}' IN ep_content WITH lc_shape_footer_right.
  ENDIF.
