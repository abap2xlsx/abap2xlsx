...
DATA lt_carrids TYPE STANDARD TABLE OF s_carr_id WITH DEFAULT KEY.

FIELD-SYMBOLS <carrid> TYPE s_carr_id.
...
START-OF-SELECTION.
  ...
  SELECT carrid FROM scarr INTO TABLE lt_carrids.       "#EC CI_NOWHERE
  LOOP AT lt_carrids ASSIGNING <carrid>.
